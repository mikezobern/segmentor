...
num_graphs = 2 # formal reply graph, author graph, time graph
...
print('batch_of_raw_graphs \n', batch_of_````````````````raw_graphs)
...
btsc = zb(batch_of_raw_message_embeddings, batch_of_raw_graphs) # B T S C
print(btsc[0])
